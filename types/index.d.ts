...
export declare function session(...itm: any[]): any;
export declare function jwt(...itm: any[]): any;
export declare function jwt_refresh(...itm: any[]): any;
...
export declare class response extends _r {
    request: request;
    [Key: string]: any;
    lang: string;
    status?: number;
...
export declare class Lycaon extends _r {
    dir: string;
